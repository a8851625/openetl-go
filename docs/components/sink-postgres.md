...
- `batch_mode`, `pk_columns`, `auto_create`, `schema_drift`: idempotency and schema controls.
...
## Evidence
Covered by `hack/e2e-mysql-postgres.sh`, `hack/e2e-cdc-postgres.sh`, and PostgreSQL sink tests.
