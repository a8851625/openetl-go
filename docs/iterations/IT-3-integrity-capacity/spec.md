...
> 状态：`active`（2026-09-08 复核：T3.1–T3.4 已交付；当前 T3.6 通用基线，T3.5 CH 决策与完整基线仍未闭合；见 [复核交付记录](./revalidation-2026-09-06.md)） | 依赖：IT-1 | 归属 roadmap 条目：RA-5、RA-6、RA-8、PR-1.3 残留、2 项待决策
...
| 产品决议 | schema evolution：仅新增列（additive-only）单独排期；当前继续拒绝破坏性变更 | 2026-09-06 用户确认 |
