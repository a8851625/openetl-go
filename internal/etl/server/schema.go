...
func sourceConfigSchemas() map[string][]ConfigField {
	return map[string][]ConfigField{
		...
		"kafka": {
			...
			{Name: "format", Type: FieldString, Required: false, Default: "json", Description: "Message format: json (flat object), envelope (Debezium-style or legacy OpenETL), canal_json (Alibaba canal flat message)", Enum: []string{"json", "envelope", "canal_json"}},
