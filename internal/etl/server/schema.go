...
func sourceConfigSchemas() map[string][]ConfigField {
	return map[string][]ConfigField{
		...
		"kafka": {
			...
			{Name: "format", Type: FieldString, Required: false, Default: "json", Description: "Message format: json (flat object), text (raw payload), envelope (Debezium-style or legacy OpenETL), or canal_json (Alibaba Canal flat message). Metadata-PK paths require an authoritative primary-key declaration and complete JSON-object key.", Enum: []string{"json", "text", "envelope", "canal_json"}},
			{Name: "on_parse_error", Type: FieldString, Required: false, Default: "raw", Enum: []string{"raw", "skip", "dlq"}, Description: "Parse-failure policy: raw (store payload under value, pre-existing), skip (drop the message), dlq (route to pipeline DLQ with context)"},
			{Name: "tombstone_policy", Type: FieldString, Required: false, Default: "delete", Enum: []string{"delete", "skip"}, Description: "Nil-value (log-compaction tombstone) policy: delete (emit OpDelete) or skip"},
			{Name: "expand_key_json", Type: FieldBool, Required: false, Default: false, Description: "Unfold a JSON-object message key into virtual __key_<col> columns"},
		...
		"rest_source": restSourceConfigFields(),
		"salesforce": append(restSourceConfigFields(), []ConfigField{
			{Name: "object", Type: FieldString, Required: false, Default: "Account", Description: "Salesforce sObject name used to build the default SOQL query URL"},
			{Name: "api_version", Type: FieldString, Required: false, Default: "v59.0", Description: "Salesforce REST API version"},
			{Name: "instance_url", Type: FieldString, Required: false, Default: "https://login.salesforce.com", Description: "Salesforce instance / login base URL"},
		}...),
		"github": append(restSourceConfigFields(), []ConfigField{
			{Name: "repo", Type: FieldString, Required: false, Description: "GitHub repository as owner/name (required when url is omitted)", Example: "octocat/Hello-World"},
			{Name: "resource", Type: FieldString, Required: false, Default: "issues", Description: "Repository resource to list", Enum: []string{"issues", "pulls", "prs", "commits", "releases"}},
			{Name: "base_url", Type: FieldString, Required: false, Default: "https://api.github.com", Description: "GitHub API base URL (override for GitHub Enterprise)"},
		}...),
		"hubspot": append(restSourceConfigFields(), []ConfigField{
			{Name: "object", Type: FieldString, Required: false, Default: "contacts", Description: "HubSpot CRM object", Enum: []string{"contacts", "deals", "tickets", "companies", "products"}},
			{Name: "base_url", Type: FieldString, Required: false, Default: "https://api.hubapi.com", Description: "HubSpot API base URL"},
			{Name: "api_key", Type: FieldString, Required: false, Description: "Legacy HubSpot API key (alias of api_key_value)", Secret: true},
		}...),
		"stripe": append(restSourceConfigFields(), []ConfigField{
			{Name: "resource", Type: FieldString, Required: false, Default: "charges", Description: "Stripe list resource", Enum: []string{"charges", "customers", "invoices", "subscriptions", "payment_intents", "payouts"}},
			{Name: "base_url", Type: FieldString, Required: false, Default: "https://api.stripe.com", Description: "Stripe API base URL"},
			{Name: "secret_key", Type: FieldString, Required: false, Description: "Stripe secret key (alias of token)", Secret: true},
			{Name: "api_key", Type: FieldString, Required: false, Description: "Alias of token/secret_key", Secret: true},
		}...),
		"notion": append(restSourceConfigFields(), []ConfigField{
			{Name: "database_id", Type: FieldString, Required: false, Description: "Notion database ID (required when url is omitted)"},
			{Name: "api_version", Type: FieldString, Required: false, Default: "2022-06-28", Description: "Notion-Version header value"},
			{Name: "base_url", Type: FieldString, Required: false, Default: "https://api.notion.com", Description: "Notion API base URL"},
			{Name: "integration_token", Type: FieldString, Required: false, Description: "Notion integration token (alias of token)", Secret: true},
		}...),
	}
}

// restSourceConfigFields 返回 rest_source 通用配置字段，模板连接器复用并追加特有字段。
func restSourceConfigFields() []ConfigField {
	return []ConfigField{
		{Name: "url", Type: FieldString, Required: false, Description: "Base request URL (supports ${var} / ${context.var} templates)", Example: "https://api.example.com/v1/items"},
		{Name: "method", Type: FieldString, Required: false, Default: "GET", Description: "HTTP method", Enum: []string{"GET", "POST", "PUT", "PATCH"}},
		{Name: "headers", Type: FieldMap, Required: false, Description: "Custom request headers (values support ${var} templates)"},
		{Name: "body", Type: FieldString, Required: false, Description: "Request body template for POST/PUT/PATCH"},
		{Name: "body_type", Type: FieldString, Required: false, Default: "json", Description: "Request body encoding", Enum: []string{"json", "form"}},
		{Name: "auth", Type: FieldString, Required: false, Default: "none", Description: "Authentication mode", Enum: []string{"none", "api_key", "basic_auth", "bearer", "oauth2_client_credentials"}},
		{Name: "auth_type", Type: FieldString, Required: false, Description: "Alias of auth for http-source compatibility", Enum: []string{"none", "api_key", "basic", "basic_auth", "bearer", "oauth2_client_credentials"}},
		{Name: "api_key_header", Type: FieldString, Required: false, Description: "Header name for API key auth", Example: "X-API-Key"},
		{Name: "api_key_query", Type: FieldString, Required: false, Description: "Query parameter name for API key auth", Example: "api_key"},
		{Name: "api_key_value", Type: FieldString, Required: false, Description: "API key value", Secret: true},
		{Name: "username", Type: FieldString, Required: false, Description: "Basic auth username"},
		{Name: "password", Type: FieldString, Required: false, Description: "Basic auth password", Secret: true},
		{Name: "auth_user", Type: FieldString, Required: false, Description: "Alias of username"},
		{Name: "auth_pass", Type: FieldString, Required: false, Description: "Alias of password", Secret: true},
		{Name: "token", Type: FieldString, Required: false, Description: "Bearer token", Secret: true},
		{Name: "auth_token", Type: FieldString, Required: false, Description: "Alias of token", Secret: true},
		{Name: "token_url", Type: FieldString, Required: false, Description: "OAuth2 token endpoint (auth=oauth2_client_credentials)"},
		{Name: "oauth2_token_url", Type: FieldString, Required: false, Description: "Alias of token_url"},
		{Name: "client_id", Type: FieldString, Required: false, Description: "OAuth2 client_id"},
		{Name: "oauth2_client_id", Type: FieldString, Required: false, Description: "Alias of client_id"},
		{Name: "client_secret", Type: FieldString, Required: false, Description: "OAuth2 client_secret", Secret: true},
		{Name: "oauth2_client_secret", Type: FieldString, Required: false, Description: "Alias of client_secret", Secret: true},
		{Name: "scopes", Type: FieldString, Required: false, Description: "Space-separated OAuth2 scopes"},
		{Name: "oauth2_scopes", Type: FieldString, Required: false, Description: "Alias of scopes"},
		{Name: "token_field", Type: FieldString, Required: false, Description: "OAuth2 access-token JSON field, or next page-token field when pagination=page_token", Default: "access_token"},
		{Name: "oauth2_token_field", Type: FieldString, Required: false, Default: "access_token", Description: "Explicit OAuth2 access-token JSON field"},
		{Name: "header_format", Type: FieldString, Required: false, Default: "Bearer %s", Description: "OAuth2 Authorization header template"},
		{Name: "oauth2_header_format", Type: FieldString, Required: false, Default: "Bearer %s", Description: "Alias of header_format"},
		{Name: "pagination", Type: FieldString, Required: false, Description: "Pagination mode", Enum: []string{"offset", "cursor", "page_token"}},
		{Name: "page_param", Type: FieldString, Required: false, Description: "Offset/page query parameter name"},
		{Name: "size_param", Type: FieldString, Required: false, Description: "Page size query parameter name"},
		{Name: "page_size", Type: FieldInt, Required: false, Default: 100, Description: "Page size"},
		{Name: "max_pages", Type: FieldInt, Required: false, Default: 0, Description: "Maximum pages to read (0 = unlimited)"},
		{Name: "total_field", Type: FieldString, Required: false, Description: "JSON path for total record count (offset pagination early stop)"},
		{Name: "cursor_param", Type: FieldString, Required: false, Description: "Cursor query parameter name"},
		{Name: "cursor_field", Type: FieldString, Required: false, Description: "JSON path for next cursor in response body"},
		{Name: "cursor_header", Type: FieldString, Required: false, Description: "Response header for next cursor (e.g. Link)"},
		{Name: "token_param", Type: FieldString, Required: false, Description: "Page-token request parameter name (page_token pagination)"},
		{Name: "result_key", Type: FieldString, Required: false, Description: "JSON path to the records array (dot-separated)"},
		{Name: "variables", Type: FieldMap, Required: false, Description: "Template variables for ${var} / ${context.var} expansion in url/headers/body"},
		{Name: "max_retries", Type: FieldInt, Required: false, Default: 3, Description: "Retry attempts for 429/5xx"},
		{Name: "retry_base_ms", Type: FieldInt, Required: false, Default: 500, Description: "Base retry delay in milliseconds; 429 Retry-After is honored when present"},
		{Name: "schema", Type: FieldMap, Required: false, Description: "Optional preflight schema hint"},
		{Name: "sample", Type: FieldMap, Required: false, Description: "Optional preflight sample response used to infer schema"},
	}
}
...
func sinkConfigSchemas() map[string][]ConfigField {
	schemas := map[string][]ConfigField{
		...
		"mysql": {
			...
			{Name: "pk_columns_from_metadata", Type: FieldBool, Required: false, Default: false, Description: "Derive per-table keys only from declared complete Metadata.PrimaryKeyColumns + JSON-object Metadata.Key. Empty/partial/conflicting identity fails closed; static pk_columns is used only as the exact legacy_verified replay safety set."},
			...
			{Name: "column_types", Type: FieldMap, Required: false, Description: "Explicit target DDL overrides for auto_create/add_columns, e.g. {deleted: 'TINYINT(1)', amount: 'DECIMAL(18,2)'}. Highest priority."},
		...
		"clickhouse": {
			...
			{Name: "pk_columns_from_metadata", Type: FieldBool, Required: false, Default: false, Description: "Derive per-table key columns only from a declared complete JSON-object Metadata.Key; incapable source formats fail preflight and incomplete records go to DLQ before sink write"},
			{Name: "version_mode", Type: FieldString, Required: false, Default: "source_order", Description: "source_order writes connector-owned UInt64 versions and tombstones; append is explicitly INSERT-only", Enum: []string{"source_order", "append"}},
			{Name: "version_column", Type: FieldString, Required: false, Default: "_version", Description: "UInt64 source-order version column for ReplacingMergeTree"},
			{Name: "delete_column", Type: FieldString, Required: false, Default: "_is_deleted", Description: "UInt8 tombstone column used as the second ReplacingMergeTree argument"},
			{Name: "hosts", Type: FieldStringArray, Required: false, Description: "Failover host list for protocol=http (host:port); connection failures round-robin to the next host"},
			{Name: "auto_create", Type: FieldBool, Required: false, Default: false, Description: "Auto-create target table if missing (source_order: two-argument ReplacingMergeTree; append: MergeTree)"},
		...
		"doris": {
			...
			{Name: "database", Type: FieldString, Required: true, Description: "Target database name"},
			{Name: "table", Type: FieldString, Required: false, Description: "Target table name. Leave empty with table_template to route per-record by metadata."},
			{Name: "table_template", Type: FieldString, Required: false, Description: "Per-record target table template (e.g. \"ods_{table}\"). {table}/{db} substitute from record metadata; enables fanning out a mixed multi-table stream (e.g. kafka source with format=envelope) into multiple Doris tables from one sink. Skips single-table schema preflight; ensure all routed tables exist or set auto_create=true."},
			...
			{Name: "auto_create", Type: FieldBool, Required: false, Default: false, Description: "Auto-create missing Doris Unique Key tables. DDL types prefer column_types, then record Metadata.ColumnTypes/source declarations, then sample inference."},
			{Name: "schema_drift", Type: FieldString, Required: false, Default: "ignore", Description: "Schema drift handling", Enum: []string{"ignore", "fail", "add_columns"}},
...
func transformConfigSchemas() map[string][]ConfigField {
	schemas := map[string][]ConfigField{
		...
		"enricher": {
			...
			{Name: "dsn", Type: FieldString, Required: false, Description: "Database DSN (mode=sql)", Example: "user:pass@tcp(host:3306)/db", Secret: true},
		...
		"lookup": {
			...
			{Name: "dsn", Type: FieldString, Required: true, Description: "DSN for dimension database", Example: "user:pass@tcp(host:3306)/db", Secret: true},
